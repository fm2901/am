...
<section class="_section_1fhxe_1">
    ...
    <div>
        <div class="swiper swiper-effect-fade-loop swiper-horizontal sl-swiper" data-autoplay="3000" style="display:flex" data-loop="true">
                ...
                if ($query->have_posts()):
                    while ($query->have_posts()): $query->the_post(); ?>
                        <div class="swiper-effect-fade-loop swiper-wrapper" style="transform: translate3d(0,0,0);max-width:300px" data-autoplay="3000" data-loop="true">
                            <div class="swiper swiper-effect-fade-loop swiper-slide sl-slide" style="margin-right: 24px" data-autoplay="3000" data-loop="true">
