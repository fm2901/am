...
//           if(effect === 'fade'){
//             // for fade effect, CSS handles opacity; manage aria only
//             slide.setAttribute('aria-hidden', String(!active));
//           } else {
//             // default behavior keeps old display toggle
//             slide.style.display = active ? '' : 'none';
//           }
//         });
//         // adjust wrapper height to active slide for fade
//         if(effect === 'fade'){
...
//
//       // Initialize height for fade effect
//       if(effect === 'fade'){
//         var h0 = slides[0] ? slides[0].offsetHeight : 0;
//         if(h0){ wrapper.style.height = h0 + 'px'; }
//       }
//
//       // Autoplay
//       if(autoplayMs > 0){
